...
//
//class ProfileTableHederView: ProfileHeaderView {
//
////    var postArray: [Post]
//
//    var postOne = Post(author: "Александр Барыкин",
//                       description: "I will ride the bike for a long time",
//                       image: "ImageOne",
//                       likes: 15,
//                       views: 38)
//    var postTwo = Post(author: "Моральный кодекс",
//                       description: "Первый луч, первый дождь. По весеннему Арбату ты идешь. Первый звук, первый снег. Эта песня о тебе и обо мне",
//                       image: "ImageTwo",
//                       likes: 58,
//                       views: 104)
//    var postThree = Post(author: "Руки вверх",
//                         description: "Крошка моя, я по тебе скучаю я от тебя письма не получаю. Ты далеко и даже не скучала, но я вернусь, вернусь, чтоб ты узнала",
//                         image: "ImageThree",
//                         likes: 48,
//                         views: 89)
//    var postFour = Post(author: "Демо",
//                        description: "Солнышко в руках и венок из звёзд в небесах и с других планет все видят нас, мне так хорошо с тобой мечтать об этом",
//                        image: "ImageFour",
//                        likes: 34,
//                        views: 68)
...
//        var postArray = [Post]()
//        postArray.append(postOne)
//        postArray.append(postTwo)
//        postArray.append(postThree)
//        postArray.append(postFour)
//        return postArray
//    }
//}
